...
namespace VoxelSeeds
{
    ...
    class VoxelRenderer
    {
        ...
        {
            _voxelTypeRenderingData[GetRenderingDataIndex(VoxelType.SPRUCE_NEEDLE)].Texture = contentManager.Load<Texture2D>("spruceneedles.png");
            ...
            _voxelTypeRenderingData[GetRenderingDataIndex(VoxelType.GRASSHOPPER)].Texture = contentManager.Load<Texture2D>("grasshopper.png");
