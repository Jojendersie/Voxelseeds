...
namespace VoxelSeeds
{
    ...
    {   //same order as the VoxelType enum
        readonly static int[] prices = {0, 0, 0, 120, 90, 152, 68, 116, 956, 0, 0, 0, 0, 0 };
        ...
        readonly static String[,] weakness = { { "", "" }, { "-", "-" }, { "-", "-" }, 
                                             ...
                                             { "-", "-" }, { "-", "-" }, { "-", "-" }, { "-", "-" }, { "-", "-" }, { "-", "-" },
                                             {"-", "-"}};
        readonly static String[] name = { "", "Ground", "Rock", "Teak", "Pine", "Spruce", "Beech", "Oak", "Redwood", "White Rot", "Noble Rot", "Termites", "House Longhorn Beetle", "Hesperophanes Cinnereus", "Grasshopper", "Leaf" };
        readonly static bool[] parasite = { false, false, false, false, false, false, false, false, false, true, true, true, true, true, true, false };
        readonly static bool[] biomass = { false, false, false, true, true, true, true, true, true, false, false, false, false, false, false, true };
        ...
        /// </summary>
        readonly static int[] maxNumberOfVoxels = { 0, 131072, 131072, 131072, 131072, 131072, 131072, 131072, 131072, 131072, 131072, 512, 512, 512, 512, 131072 };
        /// <summary>
        /// A scaling factor for voxels it is used to display bugs and beetles smaller
        /// </summary>
        readonly static float[] scalingFactor = { 1.0f, 1.0f, 1.0f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 0.5f, 0.5f, 0.5f, 0.5f, 1f};

        //readonly static int[] growingSteps = { 0, 0, 0, 18, 30, 32, 48, 46, 16, 6, 6, 2, 2, 2, 2, 5 };
        readonly static int[] growingSteps = { 0, 0, 0, 2, 4, 8, 2, 2, 2, 16, 2, 2, 2, 2, 2, 5 };

        readonly static int[] growHeight = { 0, 0, 0, 7, 10, 8, 6, 8, 19, 1, 1, 1, 1, 50, 1, 5 };
